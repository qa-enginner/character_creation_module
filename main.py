...
def special(char_name: str, char_class: str) -> str:
    """Выводит информацию о примененных умениях."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит информцию о выбранном персонаже."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выводит предложение для выбора персонажа."""
    approve_choice: str = ''
    char_class: str = ''
